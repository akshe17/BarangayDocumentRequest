...
const REJECTION_SUGGESTIONS = [
  "ID was found to be invalid upon closer inspection.",
  "The document submitted has expired since initial verification.",
  "Fraudulent or tampered ID detected after review.",
];
    ...
    <div className="min-h-screen bg-[#f6f7f9]">
      ...
      <div className="bg-white/90 backdrop-blur border-b border-slate-100 h-14 px-5 md:px-8 flex items-center justify-between sticky top-0 z-30 shadow-sm">
        ...
        <div className="flex items-center gap-2.5">
          ...
          <span className="inline-flex items-center gap-1.5 text-[10px] font-black tracking-widest uppercase px-3 py-1 rounded-full border bg-emerald-50 text-emerald-700 border-emerald-200">
        ...
        <div className="flex-1 flex flex-col gap-5">
          ...
          <div className="bg-white rounded-2xl border border-slate-100 shadow-sm overflow-hidden">
            <div className="flex items-center gap-3 px-5 py-4 border-b border-slate-50 bg-slate-50/50">
              <div
                className={`w-8 h-8 rounded-xl flex items-center justify-center shrink-0 ${isRejecting ? "bg-red-50 border border-red-100" : "bg-red-50 border border-red-100"}`}
              >
              ...
              {isRejecting ? (
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap gap-1.5 mt-2">
                      {REJECTION_SUGGESTIONS.map((suggestion, i) => (
                        <button
                          key={i}
                          ...
                          className="inline-flex items-center gap-1 px-3 py-1.5 rounded-full border text-[11px] font-semibold
                            ...
                            disabled:opacity-40"
                        >
                          <Sparkles size={9} className="shrink-0 opacity-50" />
                ...
                <div className="space-y-3">
                  <p className="text-sm text-slate-500 leading-relaxed font-medium">
                    This resident is verified and has full portal access. Only
                    reject if you have a valid reason to revoke their
                    verification.
                  </p>
                  <button
      ...
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
          ...
          <button
            ...
            disabled={isLoading}
            title="Refresh"
            className="p-3 bg-white border border-slate-200 rounded-xl hover:bg-emerald-50 hover:border-emerald-200 hover:text-emerald-600 transition-all text-slate-500 shadow-sm disabled:opacity-50 self-start md:self-auto cursor-pointer"
          >
