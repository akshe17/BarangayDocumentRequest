          ...
          <div className="overflow-y-auto max-h-[90vh] sm:max-h-[85vh]">
            <div className="bg-white p-5 sm:p-8 pb-safe">
              ...
              <div className="flex justify-between items-start mb-6">
                ...
                <button
                  onClick={onClose}
                  className="flex-shrink-0 text-gray-400 hover:text-gray-600 rounded-full p-2 hover:bg-gray-100 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-amber-500 focus:ring-offset-2 -mt-1"
              ...
              <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-5">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 sm:pl-12 pr-12 py-3 sm:py-3.5 border border-gray-300 rounded-xl text-sm focus:ring-2 focus:ring-amber-500 focus:border-amber-500 transition-all"
                    required
                    minLength="8"
                  />
                  <button
